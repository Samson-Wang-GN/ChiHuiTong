...
最新需求REQ-051：取消旧三方合同业务分类；门诊开通改为填写合同项后自动生成、下载打印、签署照片回传再提交审核。流程和版本规则已记录，正式合同范本待提供，代码/页面尚未实现本条；见[TASK-110](docs/tasks.md)及[ADR-0033](docs/decisions/0033-generated-bilateral-clinic-contracts.md)。下方已发布版本不代表此新流程已上线。
