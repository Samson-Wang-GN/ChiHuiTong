...
class NotificationTests(TestCase):
    ...
    def test_contract_notice_links_latest_version_without_cross_recipient_access(self):
        ...
        notice = Notification.objects.create(
            recipient=self.resource.membership,
            dedup_key="synthetic-contract-link",
            kind="contract.expiring",
            object_type="contract",
            object_id=version.contract_id,
            title="合成合同到期提醒",
        )
    ...
    def test_unsafe_production_backend_leaves_explicit_failed_attempt_not_sending(self):
        ...
        with override_settings(
            ...
            SMS_BACKEND="chihuitong.tests.test_notifications.MemoryBusinessSMS",
        ):
            jobs.run_one()
