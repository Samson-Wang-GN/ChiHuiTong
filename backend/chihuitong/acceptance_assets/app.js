(function(){
  ...
  function Login({onLogin,notice}){
    const [phone,setPhone]=React.useState(phones[C.role]||''),[code,setCode]=React.useState(''),[error,setError]=React.useState(null),[busy,setBusy]=React.useState(false),[sms,setSms]=React.useState(null),[wait,setWait]=React.useState(0),[members,setMembers]=React.useState([]),[chosen,setChosen]=React.useState(null),[reminder,setReminder]=React.useState(true);
