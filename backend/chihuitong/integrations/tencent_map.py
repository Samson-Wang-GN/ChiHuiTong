...
def static_map(latitude, longitude, zoom):
    ...
    require(settings.TENCENT_MAP_KEY, "map_not_configured", "地图服务尚未配置，请联系平台配置后核对位置", 503)
    ...
    try:
        ...
        with Image.open(io.BytesIO(raw)) as picture:
            require(picture.format == "PNG" and picture.size == (600, 360), "map_response", "地图图片格式异常", 503)
            picture.verify()
